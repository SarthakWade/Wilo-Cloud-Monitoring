...
class EnhancedWebSocketServer:
    ...
    async def load_csv_data(self, filename):
        """Load CSV data from file and convert to format expected by frontend.
        Supports both legacy 'Timestamp' column and new 'Time (ms)' column formats.
        """
...
"""
    ...
    async def handle_command(self, websocket, command_data):
        ...
        # Sampling rate is now fixed - command removed
        ...
        if command == 'get_status':
            ...
            try:
                ...
                recent_files = files[:100]  # Get more files to ensure we capture very recent data
